...
class TestExtractor(unittest.TestCase):
    def __init__(self, methodName: str = ...):
        ...
        self.download_path = "D:\Github\made_ws24\\data"
...
class TestLoader(unittest.TestCase):
    def __init__(self, methodName: str = ...):
        ...
        self.t.transform_data_delete_null()
        self.t.sync_both_data()
        self.output_file_u = "D:\Github\made_ws24\data\unemployment.csv"
        self.output_file_c = "D:\Github\made_ws24\data\crime.csv"
